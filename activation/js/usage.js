  ...
  render() {
    return /*#__PURE__*/ React.createElement(
      ...
      this.props.data.map((device) =>
        /*#__PURE__*/ React.createElement(DeviceCard, { device: device })
      )
    );
  }
}
...
class DeviceCard extends React.Component {
  ...
  render() {
    return /*#__PURE__*/ React.createElement(
      ...
      React.createElement(Device_section__info, {
        data: this.props.device,
      }) /*#__PURE__*/,
      React.createElement(Device_section__sideBarMenu, null) /*#__PURE__*/,
      React.createElement(Device_action__toggleMenu, {
...
class Device_section__info extends React.Component {
  render() {
    return /*#__PURE__*/ React.createElement(
      ...
      React.createElement(Device_section__mastHead, {
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "a",
          { href: "#" },
          /*#__PURE__*/ React.createElement("i", { className: "fa fa-wifi" }),
          "Wireless Settings"
        )
      ) /*#__PURE__*/,
      ...
      React.createElement(
        ...
        React.createElement(
          "a",
          { href: "#" },
          /*#__PURE__*/ React.createElement("i", { className: "fa fa-photo" }),
          "Edit Photos"
        )
      ) /*#__PURE__*/,
...
class Device_action__toggleMenu extends React.Component {
  render() {
    return /*#__PURE__*/ React.createElement(
      "div",
      { className: "toggle" } /*#__PURE__*/,
      React.createElement(
        "a",
        { href: "#", onClick: this.props.toggleClick },
        /*#__PURE__*/ React.createElement("i", { className: "fa fa-cog" })
      )
    );
  }
}
...
class Device_section__mastHead extends React.Component {
  render() {
    ...
    return /*#__PURE__*/ React.createElement(
      "header",
      { className: "masthead" } /*#__PURE__*/,
      React.createElement(
        "div",
        { className: "device-icon" } /*#__PURE__*/,
...
class Device_section__freeSpace extends React.Component {
  render() {
    const widthPhoto = Math.round(
      ((this.props.data.photoTotalSpace +
        this.props.data.videoTotalSpace +
        this.props.data.systemSpace) /
        this.props.data.availableSpace) *
        100
    );
    const widthVideo = Math.round(
      ((this.props.data.videoTotalSpace + this.props.data.systemSpace) /
        this.props.data.availableSpace) *
        100
    );
    const widthSystem = Math.round(
      (this.props.data.systemSpace / this.props.data.availableSpace) * 100
    );
    ...
    return /*#__PURE__*/ React.createElement(
      "article",
      { className: "device-info" } /*#__PURE__*/,
      React.createElement(
        "div",
        { className: "device-space" } /*#__PURE__*/,
        React.createElement("h3", null, "Storage Usage") /*#__PURE__*/,
        React.createElement(
          "div",
          { className: "available-space" } /*#__PURE__*/,
          React.createElement("div", {
            className: "used-space--photos",
            style: usedSpacePhotoStyle,
          }) /*#__PURE__*/,
          React.createElement("div", {
            className: "used-space--videos",
            style: usedSpaceVideoStyle,
          }) /*#__PURE__*/,
          React.createElement("div", {
            className: "used-space--system",
            style: usedSpaceSystemStyle,
          })
        )
      ) /*#__PURE__*/,
      ...
      React.createElement(
        "ul",
        { className: "device-legend" } /*#__PURE__*/,
        React.createElement(
          "li",
          null,
          /*#__PURE__*/ React.createElement("i", {
            className: "fa fa-circle system",
          }),
          " Apps"
        ) /*#__PURE__*/,
        React.createElement(
        ...
        React.createElement(
          ...
          null,
          /*#__PURE__*/ React.createElement("i", {
            className: "fa fa-circle available",
          }),
          " Available"
        )
      )
